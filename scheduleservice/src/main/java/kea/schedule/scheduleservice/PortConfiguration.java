...
public class PortConfiguration {
    ...
    public ServletWebServerFactory servletContainer() {
        ...
        TomcatServletWebServerFactory tomcat = new TomcatServletWebServerFactory(serviceport) {
    ...
    private Connector[] getAdditionalConnectors() {
        ...
        System.out.println("httpPort = " + studentport);
        httpcon.setPort(studentport);
        ...
        httpcon.setSecure(true);
        httpcon.setRedirectPort(studentport);
        c[0] = httpcon;

        //Service port
        Connector servicecon = new Connector(TomcatServletWebServerFactory.DEFAULT_PROTOCOL);
        servicecon.setScheme("http");
        System.out.println("service port = " + teacherport);
        servicecon.setPort(teacherport);
